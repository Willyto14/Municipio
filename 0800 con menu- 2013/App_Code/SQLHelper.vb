...
#Region "private utility methods & constructors"
    ...
    Private Overloads Shared Sub AssignParameterValues(ByVal commandParameters() As SqlParameter, ByVal parameterValues() As Object)
        ...
        If commandParameters.Length <> parameterValues.Length Then
            Throw New System.ArgumentNullException("Parameter count does not match Parameter Value count.")
        End If
    ...
    Private Shared Sub PrepareCommand(ByVal command As SqlCommand, _
        ...
        If Not (transaction Is Nothing) Then
            If transaction.Connection Is Nothing Then Throw New System.ArgumentNullException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction")
...
#Region "ExecuteNonQuery"
    ...
    Public Overloads Shared Function ExecuteNonQuery(ByVal transaction As SqlTransaction, _
        ...
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then Throw New System.ArgumentNullException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction")
        ...
        Try
            ...
            If Not tableNames Is Nothing AndAlso tableNames.Length > 0 Then
                ...
                For index = 0 To tableNames.Length - 1
                    If (tableNames(index) Is Nothing OrElse tableNames(index).Length = 0) Then Throw New System.ArgumentNullException("The tableNames parameter must contain a list of tables, a value was provided as null or empty string.", "tableNames")
...
#Region "private methods, variables, and constructors"
    ...
    Private Shared paramCache As System.Collections.Hashtable = Hashtable.Synchronized(New Hashtable)
